...
subtitle: function(data) {
	const info = ['Percentage Of Number', 'Increase Number By', 'Decrease Number By'];
...
short_description: "Do basic operations involving percentages",
...
<div style="padding-top: 8px; width: 60%;">
	...
	<select id="info" class="round">
            <option value="0" selected>Percentage Of Number</option>
			<option value="1">Increase Number By</option>
			<option value="2">Decrease Number By</option>
	</select>
</div><br>

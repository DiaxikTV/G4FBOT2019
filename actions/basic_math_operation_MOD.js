...
subtitle: function(data) {
	const info = ['Addition', 'Subtraction', 'Multiplication', 'Division', 'Raised by', 'Rooted by', 'Round to S.F.'];
...
<div style="padding-top: 8px; width: 60%;">
	...
	<select id="info" class="round">
			...
			<option value="4">Raised by</option>
			<option value="5">Rooted by</option>
			<option value="6">Round to S.F.</option>
	</select>
</div><br>
<div style="width: 90%;">
	Second Number:<br>
